...
contract SKULL is ERCX {
    ...
    string private constant _name = "SKULL KOLLEKTOR";
    string private constant _ticker = "SKULL";
    ...
    constructor() ERCX("", _name, _ticker, _decimals, _totalTokens, _tokensPerNFT) {
        dataURI = "https://skullkollektor.com";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            if (seed <= 5) {
                image = "/assets/images/image03.png?v=24326b79";
                rarity = "SUPREME";
                description = "A Supreme Skull Trophy: The ultimate accolade, signifying an unparalleled feat of strength and bravery in the face of the deadliest demons.";
            } else if (seed <= 25) {
                image = "/assets/images/image07.png?v=24326b79";
                rarity = "LEGENDARY";
                description = "A Legendary Skull Trophy: A testament to epic triumphs, this trophy is earned by those who rewrite the annals of battle with their valor.";
            } else if (seed <= 75) {
                image = "/assets/images/image06.png?v=24326b79";
                rarity = "EPIC";
                description = "An Epic Skull Trophy: Awarded for extraordinary deeds, this symbolizes the bearer's heroic conquest over formidable demonic foes.";
            } else if (seed <= 150) {
                image = "/assets/images/image05.png?v=24326b79";
                rarity = "RARE";
                description = "A Rare Skull Trophy: A mark of distinction, earned by outsmarting and defeating demons of cunning and guile, showcasing tactical mastery.";
            } else {
                image = "/assets/images/image04.png?v=24326b79";
                rarity = "COMMON";
                description = "An Uncommon Skull Trophy: Honoring the victory over lesser-known demons, this trophy signifies the growing legend of the bearer.";
            }

            string memory jsonPreImage = string(abi.encodePacked('{"name": "SKULL KOLLEKTOR #', id.toString(), '","description":"', description, '","external_url":"https://skullkollektor.com/","image":"', dataURI, image));
